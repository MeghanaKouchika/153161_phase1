...
public class TestClass1 {
	...
	{
		service.createAccount(null, "7095134616", new BigDecimal(2000));
	}
	...
	{
		service.createAccount("", "7095134616", new BigDecimal(2000));
	}
	...
	{
		Customer actual = service.createAccount("Meghana", "7095134616", new BigDecimal(5000));
	...
	{
		service.createAccount("Meghana", "7095134616", new BigDecimal(9000));
